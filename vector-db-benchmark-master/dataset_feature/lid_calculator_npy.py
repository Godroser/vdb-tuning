"""
Local Intrinsic Dimension (LID) Calculator for random-geo-radius-100-angular/random_geo_1m_no_filters dataset
"""
...
if __name__ == "__main__":
    ...
    sample_size = 10000                              # None 表示用全部数据，20000 表示采样
    seed = 42
    # =====================
    ...
    # Print results
    print("\n" + "=" * 60)
    print("LID STATISTICS for random-geo-radius-100-angular/random_geo_1m_no_filters:")
