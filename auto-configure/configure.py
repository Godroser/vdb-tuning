...
with open('/home/dzh/project/vdtuner/auto-configure/index_param.json', 'r') as f:
    INDEX_PARAM_DICT = json.load(f)

CONF_PATH = r'/home/dzh/project/vdtuner/vector-db-benchmark-master/experiments/configurations/milvus-single-node.json'
ORIGIN_PATH = r'/home/dzh/project/vdtuner/vector-db-benchmark-master/engine/servers/milvus-single-node/milvus.yaml.backup'
ADJUST_PATH = r'/home/dzh/project/vdtuner/vector-db-benchmark-master/engine/servers/milvus-single-node/milvus.yaml'
